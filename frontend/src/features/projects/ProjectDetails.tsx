...
const ProjectDetails = () => {
    ...
    const mockProject: ProjectDetailData = {
        ...
        rubric: {
            ...
            description: 'Evaluation criteria for urban planning projects',
            criteria: [
                { criterion_name: 'Technical Viability', weight: 0.3, max_score: 100, description: 'Scientific accuracy of energy and waste models.' },
                { criterion_name: 'Interdisciplinary Insight', weight: 0.25, max_score: 100, description: 'Synthesis of economic and social factors.' },
                { criterion_name: 'Creative Delivery', weight: 0.25, max_score: 100, description: 'Novelty of solutions and presentation quality.' },
                { criterion_name: 'Team Collaboration', weight: 0.20, max_score: 100, description: 'Balanced contribution and evidence of group work.' },
            ]
        }
    };
