        ...
        <div className="space-y-8 relative pb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 animate-slide-up" style={{ animationDelay: '100ms' }}>
                {[
                    ...
                    { title: 'Class Analytics', icon: BarChart2, color: 'bg-emerald-500', path: '/dashboard/analytics' },
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={masteryGaps}>
                                ...
                                <Bar dataKey="gap" radius={[4, 4, 0, 0]} barSize={20}>
                                    ...
                                    <LabelList dataKey="gap" position="top" fill="#ffffff" fontSize={10} formatter={(value: number) => `${value}%`} />
                                </Bar>
                            </BarChart>
                        </ResponsiveContainer>
                    </div>
